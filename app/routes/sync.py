...
def release_reservation(order_id: str, x_tenant_id: str = Header()):
    ...
    # Return the stock and drop the reservation row atomically: if either
    # statement fails, both are rolled back and the error propagates, so a
    # reservation is never deleted without its stock being returned.
